...
void IrqGtm_Init(void)
{
  ...
  #if (IRQ_GTM_ATOM0_EXIST == STD_OFF)
  ...
  #if (IRQ_GTM_ATOM1_EXIST == STD_OFF)
  ...
  #if (IRQ_GTM_ATOM2_EXIST == STD_OFF)
  ...
  #if (IRQ_GTM_ATOM3_EXIST == STD_OFF)
  ...
  #if (IRQ_GTM_ATOM4_EXIST == STD_OFF)
  ...
  #if (IRQ_GTM_ATOM5_EXIST == STD_OFF)
  ...
  #if (IRQ_GTM_ATOM6_EXIST == STD_OFF)
  ...
  #if (IRQ_GTM_ATOM7_EXIST == STD_OFF)
  ...
  #if (IRQ_GTM_ATOM8_EXIST == STD_OFF)
  ...
  #if (IRQ_GTM_ATOM9_EXIST == STD_OFF)
  ...
  #if (IRQ_GTM_ATOM10_EXIST == STD_OFF)
  ...
  #if (IRQ_GTM_ATOM11_EXIST == STD_OFF)
